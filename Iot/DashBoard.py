...
grafico_humedad = dcc.Graph(id = 'grafico_humedad',
                           animate=True,
                           config = {'displayModeBar': 'hover'},
                           className = 'chart_width'),

grafico_temp = dcc.Graph(id = 'temperature_chart',
                              animate=True,
                              config = {'displayModeBar': 'hover'},
                              className = 'chart_width')
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Div([
                dcc.Tabs(id = "tabs-styled-with-inline", value = 'grafico_temp', children = [
                    dcc.Tab(grafico_humedad,
                            label = 'Humedad',
                            value = 'grafico_humedad',
                            style = tab_style,
                            selected_style = tab_selected_style,
                            className = 'font_size'),
                    dcc.Tab(grafico_temp,
                            label = 'Temperature',
                            value = 'grafico_temp',
                            style = tab_style,
                            selected_style = tab_selected_style,
